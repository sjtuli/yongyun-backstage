		...
		<el-form :model="form" :rules="rules" ref="ruleForm" label-width="150px">
			<div class="container add_edit">
				...
				<div>
					...
					<el-form-item label="商品名称" prop="name" ref="name"><el-input placeholder="请输入商品名称" v-model="form.name"></el-input></el-form-item>
			...
			<div class="container add_edit">
				...
				<div>
					...
					<el-form-item label="商品标签">
						<el-checkbox-group v-model="goodsDatas"><el-checkbox v-for="item in goodsTags" :label="item.name" :key="item._id"></el-checkbox></el-checkbox-group>
						<div class="remark_txt">此选项表示商品所属商品</div>
					</el-form-item>
					<el-form-item label="服务标签">
						<el-checkbox-group v-model="serveDatas"><el-checkbox v-for="item in serveTags" :label="item.name" :key="item._id"></el-checkbox></el-checkbox-group>
